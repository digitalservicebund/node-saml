...
class SAML {
    ...
    initialize(ctorOptions) {
        ...
        const options = {
            ...
            signatureAlgorithm: (_x = ctorOptions.signatureAlgorithm) !== null && _x !== void 0 ? _x : "sha1", // sha1, sha256, sha256-mgf1 or sha512
    ...
    signRequest(samlMessage) {
        ...
        const privateKey = (0, crypto_1.keyInfoToPem)(this.options.privateKey, "PRIVATE KEY", "privateKey");
        const signParams = this.options.signatureAlgorithm !== "sha256-mgf1"
            ? privateKey
            : {
    ...
    generateServiceProviderMetadata(decryptionCert, publicCerts) {
        return (0, metadata_1.generateServiceProviderMetadata)({ ...this.options, decryptionCert, publicCerts });
    }
    /**
